...
function Page() {
  ...
  return (
    <div>
      ...
      <Header
        title={"Journaling"}
        text={"Journaling is a way to record your thoughts and feelings, and to reflect on your life and the people around you. In this section, you’ll be able to write down whatever you're thinking at any time."}
      />
      <TodayEntryProvider>
        <SuggestedQuestions />
        <Editor />
